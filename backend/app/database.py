...
def init_db() -> None:
    if is_postgres():
        print("[DB] PostgreSQL/Supabase detectado. Usando schema existente do Supabase.", flush=True)
        ...
        execute(
            ...
            """,
            (DEFAULT_SUPABASE_USER_ID, "Usuário Teste", "teste@studyflow.local", None),
        )
        execute(
            """
